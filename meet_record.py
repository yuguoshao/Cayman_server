...
class meet_record:
   ...
   def upload_ssh_twice(self,path,f):
      host = "peking.tjcpt.com"  #服务器ip地址
      port = 22  # 端口号
      username = "root"  # ssh 用户名
      password = "HUSTsvo123456"  # 密码
      ...
      scpclient = SCPClient(ssh_client.get_transport())
      local_path = path
      remote_path = "/home/wwwroot/default/course"
      try:
         scpclient.put(local_path, remote_path)
         #os.remove(path)
         #self.deltorecyclebin(path)
         ...
         print(e)
         print("系统找不到指定文件_1" + local_path)
      else:
         print("文件上传成功_1")
      ssh_client.exec_command("chmod 777 /home/wwwroot/default/course/*")
      ssh_client.close()
